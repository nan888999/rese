              ...
              <div class="modal__content">
                ...
                <div class="modal__body">
                  ...
                  <div class="review-form">
                    ...
                    @csrf
                      <input type="hidden" name="reservation_id" value="{{ $reserved_data->id ?? '' }}">
                      <input type="hidden" name="shop_id" value="{{ $reserved_data->shop_id ?? '' }}">
